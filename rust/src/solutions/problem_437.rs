...
impl Solution {
    fn recur_437(
        ...
        if let Some(node) = root {
            ...
            let l = Self::recur_437(&node_br.left, count_table, target, sum);
            let r = Self::recur_437(&node_br.right, count_table, target, sum);
    ...
    pub fn path_sum(root: Option<Rc<RefCell<TreeNode>>>, target_sum: i32) -> i32 {
        ...
        Self::recur_437(&root, &mut count_table, target_sum as i64, 0) as i32
    }
}
